...
public class DeleteIncident extends RestAssuredBase {
	...
	public void delete() {
    	...
    	Response response = RestAssured.given().header("Authorization","Bearer cyTohkhJERJZKfqy4TNfJwVlS6uTUb5ozvmVgjFguQ3iCQVbkJfelfumjm80renOu_r9HCUInR_0ZFqhZ6217g")
